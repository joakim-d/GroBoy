...
L'algorithme principal mis en place, l'étape suivante était le remplissage de la matrice de pixels. Pour cela nous avons implémenté une fonction gpu\_drawline(), qui comme son nom l'indique va remplir une ligne de la matrice, cette fonction est appelée par l'algorithme vu précédent, lorsque le GPU passe en période de HBlank. Son fonctionnement est le suivant:\\
\begin{itemize}
