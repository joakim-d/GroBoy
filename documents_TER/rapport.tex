...
\makeglossary
\newglossaryentry{ROMS}
{
	name={ROMS},
  	description={Terme utilisé pour désigner des copies de cartouche de jeu sous forme de fichier et donc lisible par un émulateur. Par exemple "la rom de Mario" désigne la copie du jeu Mario.}
}
\newglossaryentry{ROM}
{
	name={ROM},
        description={En anglais Read Only Memory, il s'agit de la mémoire morte. Elle ne s'efface pas lors de la mise hors tension du système.}
}
\newglossaryentry{RAM}
{
	name={RAM},
	description={En anglais Random Access Memory, il s'agit de la mémoire vive. Elle est accessible en lecture/écriture par les différents composants reliés à elle. Néanmoins une fois le circuit hors tension, cet espace mémoire devient instable.}
}
\newglossaryentry{VRAM}
{
	name={VRAM},
	description={La VRAM correspond à la RAM vidéo de la Game Boy, sa taille est de 8 Ko. C'est elle qui contient tous les dessins des jeux.}
}
\newglossaryentry{CPU}
{
	name={CPU},
	description={En anglais Central Processing Unit, il s'agit du processeur principal d'un système. Il a pour rôle d'exécuter les programmes.}
}
\newglossaryentry{GPU}
{
	name={GPU},
	description={En anglais Graphical Processing Unit, il s'agit du processeur qui traite la partie graphique d'un système.}
}
\newglossaryentry{MMU}
{
	name={MMU},
	description={En anglais Memory Management Unit, il s'agit d'un composant responsable de l'accès à la mémoire demandée par le processeur.}
}
\newglossaryentry{APU}
{
	name={APU},
	description={An anglais Audio Processing Unit, il s'agit du processeur qui traite la partie sonore d'un système.}
}
...
\printglossaries
\newpage
\section*{\centering{TER, développement d'un émulateur de \\Game Boy}}
\vspace{2cm}
